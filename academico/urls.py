...
urlpatterns = [
    ...
    path('calendario/', views.CalendarioAcademicoView.as_view(), name='calendario'),
    ...
    path('expedientes/<int:pk>/generar-empastado/', views.GenerarEmpastadoView.as_view(), name='generar_empastado'),
