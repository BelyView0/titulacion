# Corrige migración 0025 — rol admin es 'ADMIN', no 'ADMINISTRADOR'
...
def migrar_email_admin_a_institucional(apps, schema_editor):
    ...
    for usuario in Usuario.objects.filter(rol='ADMIN'):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('administracion', '0025_admin_email_institucional'),
    ]
